...
export class CartManager {
    ...
    async getCarts() {
        try {
            ...
            throw new Error("Error fetching carts from the file");
        }
    }
    ...
    async createCart() {
        try {
            if (this.fileExists()) {
                ...
                throw new Error("Error creating the cart: error fetching carts from the file");
            }
        } catch (error) {
            throw error;
        }
    ...
    async getCartById(id) {
        try {
            if (this.fileExists()) {
                ...
                throw new Error("Error searching for the cart: error fetching carts from the file");
            }
        } catch (error) {
            throw error;
        }
    ...
    async addProductToCart(cartId, productId, quantity) {
        try {
            if (this.fileExists()) {
                ...
                throw new Error("Error adding the product to the cart: error fetching carts from the file");
            }
        } catch (error) {
            throw error;
        }
